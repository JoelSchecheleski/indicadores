...
namespace NinjaTrader.NinjaScript.Strategies
{
    public class JsStrategyDynamics : Strategy
    {
        ...
        protected override void OnBarUpdate()
        {
            ...
            bool buySignal = jsIndicator.Values[3][0] > 0; // Verifica se há um sinal de compra
            bool sellSignal = jsIndicator.Values[4][0] > 0; // Verifica se há um sinal de venda
